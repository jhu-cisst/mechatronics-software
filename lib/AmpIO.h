...
public:
    ...
    */
    ...
    /*! \brief Get Si SUJ potentiometer positions.
    ...
    */
    bool GetSiSUJPositions(std::array<int16_t, 10> &positions) const;
    bool ReadSiSUJPresense(bool &ESSJPresent, bool &dSIBSiPresent, bool &dSIBZSiPresent) const;
